...
def main():
    # Configuration
    csv_file = 'datasets/cassandra_ARBIssues.csv'  # Path to your CSV file containing bug IDs
    repo_dir = '../../cassandraSoftware/cassandra'  # Path to your cloned Apache Hive repository
    output_csv = '../../code/Casssandra_Extraction/datasets/bug_id_file_mapping.csv'  # Output CSV file path
